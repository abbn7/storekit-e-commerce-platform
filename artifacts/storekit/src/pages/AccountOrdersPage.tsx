...
import { SignedIn, SignedOut, RedirectToSignIn, useUser } from "@clerk/react";
                ...
                >
                  <div className="flex items-start justify-between flex-wrap gap-4">
                    ...
                    <div className="text-right">
                      <span className={`inline-block px-2.5 py-1 text-[10px] tracking-[0.1em] uppercase rounded-full font-medium ${statusColors[order.status] ?? "bg-muted text-muted-foreground"}`}>
                        {order.status}
                      </span>
...
export default function AccountOrdersPage() {
  return (
    <>
      <SignedIn><OrdersContent /></SignedIn>
